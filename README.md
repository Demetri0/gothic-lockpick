...
Стрип позиций (кнопки `◄ N ►` над матрицей) и **клик по дырке в 3D-виде**:
- выставляет позицию напрямую, **без проверки зависимостей**
- инструмент конфигурации: любое положение можно задать независимо от других плашек
- в 3D-виде при наведении на дырку показывается подсветка; клик (или тап) выставляет позицию той плашки, по дырке которой кликнули
