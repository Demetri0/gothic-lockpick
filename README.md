...
Клавиатура в режиме решения:
- `W / S` или `↑ / ↓` — выбор активной плашки
- `A / D` или `← / →` — свободное перемещение плашки (переход в режим исследования)

В режиме исследования пройденные шаги BFS и разделитель «↩ вернуться к шагу N» кликабельны — возвращают к любой точке решения.
