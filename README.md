...
2. **Дедуп-ревью**: 83 канонические группы дублей (пережившие старый строковый дедуп), 78 слито владельцем через ревью-тулзу — база ужалась 508 → 398 записей с объединением имён/тегов/языков.
