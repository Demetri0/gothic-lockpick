...
// Per-invariant validation (ids/positions/currentPos/deps/self-dep/counts) is tested
// directly on validatePlates in config-parsers.spec.js. The two UI-wiring cases above
// ('valid config is applied' / 'invalid JSON is rejected') cover the dialog+toast path.
...
// chests.ini). Those cases are covered by gothic.parseRules unit tests in
...
// ── Gothic export (gothic.serialize) ────────────────────────────────────
